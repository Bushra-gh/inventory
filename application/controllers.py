...
def manager():
  ...
  return render_template("admin_dashboard.html", this_user=this_user, all_prod=all_prod)

@app.route("/home/<int:user_id>")
def home(user_id):
  this_user = User.query.filter_by(id=user_id).first()
  all_prod = Product.query.all()
  return render_template("user_dashboard.html", this_user=this_user, all_prod=all_prod)
...
def m_requests():
  ...
  return render_template("admin_requests.html", this_user=this_user, all_req=all_req)
...
def u_requests(user_id):
  ...
  return render_template("user_requests.html", this_user=this_user, all_req=all_req, total = total)
